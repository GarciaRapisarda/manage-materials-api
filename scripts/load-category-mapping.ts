...
import { CATEGORY_MAP } from "./alumetal-category-map";

const MAPPING_JSON = path.join(__dirname, "alumetal-category-mapping.json");
const MAPPING_CSV = path.join(process.cwd(), "scripts", "output", "alumetal-category-mapping.csv");
