...
import { CATEGORY_MAP } from "./moreno-category-map";

const MAPPING_JSON = path.join(__dirname, "moreno-category-mapping.json");
const MAPPING_CSV = path.join(
  process.cwd(),
  "scripts",
  "output",
  "moreno-category-mapping.csv"
);

export function loadMorenoMapping(): Record<string, string> {
