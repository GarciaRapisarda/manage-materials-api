...
import { CATEGORY_MAP } from "./merlino-category-map";

const MAPPING_JSON = path.join(__dirname, "merlino-category-mapping.json");
const MAPPING_CSV = path.join(
  process.cwd(),
  "scripts",
  "output",
  "merlino-category-mapping.csv"
);

export function loadMerlinoMapping(): Record<string, string> {
